...
<head>
   ...
   <title>{{$title}} | BlessedStores</title>
      ...
      <div class="header">
         <div class="header-top-area grocery__top-header">
            <div class="header-layout-4">
               <div class="header-to-main d-sm-flex flex-column flex-md-row">
                  <div class="link-text">
                     <span><img src="{{asset('imgs/icons/call.png')}}" alt=""></span>
                     <a href="tel:+380961381876">+380961381876</a>
                  </div>
                  <div class="header-top-notice mt-3 mt-md-0 text-center">
               ...
               <div class="footer-grid-3">
                  <div class="footer-widget-4">
                     <div class="footer-logo mb-35">
                        <a href="{{ route('home') }}"><img src="{{asset('imgs/logo/logo.png')}}"
            ...
            <div class="footer-copyright-wrapper">
               <div class="footer-copyright-text">
                  <p class="mb-0">© All Copyright 2024 by <a target="_blank" class="furniture-clr-hover"
                        href="https://www.blessed-tech.vercel.app">BlessedTech</a></p>
               </div>
               <div class="footer-payment d-flex align-items-center gap-2">
                  <div class="footer-payment-item mb-0">
                     <div class="footer-payment-thumb">
                        <img src="{{asset('imgs/icons/payoneer.png')}}" alt="">
                     </div>
                  </div>
                  <div class="footer-payment-item mb-0">
                     <div class="footer-payment-thumb">
                        <img src="{{asset('imgs/icons/maser.png')}}" alt="">
                     </div>
                  </div>
                  <div class="footer-payment-item">
                     <div class="footer-payment-thumb">
                        <img src="{{asset('imgs/icons/paypal.png')}}" alt="">
                     </div>
                  </div>
               </div>
