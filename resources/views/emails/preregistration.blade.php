...
<head>
  ...
  <style>
    ...
    .email-wrap{width:100%;background:#b18b5e;padding:32px 16px}
    .email-body{max-width:600px;margin:0 auto;background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #ececec}
