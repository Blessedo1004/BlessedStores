        ...
        <aside class="dashboard-sidebar d-flex flex-col justify-between" id="dashboardSidebar">
            <div>
                ...
                <nav class="nav flex-column mt-4">
                    ...
                    @can('store')
                      <a href="{{ route('products') }}" class="nav-link {{ request()->routeIs('products') || request()->routeIs('products.create') || request()->routeIs('products.edit') ? 'active' : ''}}" wire:navigate>
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @if (Gate::allows('super-admin') || Gate::allows('admin'))
                          <a class="nav-link {{ request()->routeIs('store-applications') ? 'active' : ''}}" href="{{ route('store-applications') }}" wire:navigate>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> 
