...
new class extends Component
{
    ...
    public function save(){
       ...
       // Rate limiting 
       $key = 'create-category:' . request()->ip();
...
<div class="dashboard-content">
        ...
        @endif
        <div class="mb-4">
            <h5 class="fw-bold text-dark mb-1">Add New Category</h5>
            <p class="text-muted small mb-0">Provide category details to create a new category.</p>
        </div>
